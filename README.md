...
I build AI-powered systems and full stack applications with a strong focus on security and real-world execution.

Currently working on:
• Voice-enabled AI automation systems  
• AI-based healthcare models (CT scan analysis)  
• Secure and scalable full stack applications  

💡 My approach:  
**Execution > Theory** — I focus on building systems that actually work in real environments.
...
🔐 Cybersecurity Focus:
• Understanding system vulnerabilities and secure architecture  
• Working with ethical hacking concepts & Linux tools  
• Applying security-first mindset in development  

🤝 Open to:
Collaborations on AI, cybersecurity, automation, and impactful tech projects  

---

## 🚀 Featured Projects

### 🔥 Voice AI Automation Assistant
A voice-enabled system capable of executing browser actions like scrolling, navigation, and form automation using natural language commands.

### 🧬 AI Lung Cancer Detection (CT Scan)
Deep learning-based system for early detection of lung cancer using CT scan imaging.

### 🌐 Secure Full Stack Applications
Built scalable web applications with authentication, APIs, dashboards, and security-aware architecture.

---

## 🌐 Connect With Me

[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/adarshrsharma/)  
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/its_adarsh_2612/)  
[![X](https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white)](https://x.com/adarsh261206)  
[![Email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:adarsh2612006@gmail.com)
...
**Building secure, real-world systems — not just projects.**
